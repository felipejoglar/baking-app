...
/**
 * Adapter that manages a collection of {@link Recipe} for widget configuration.
 */
public class RecipeWidgetAdapter extends RecyclerView.Adapter<RecipeWidgetAdapter.ViewHolder> {

    private static final String TAG = RecipeWidgetAdapter.class.getSimpleName();

    private final WidgetRecipeClickListener mOnWidgetRecipeClickListener;
    private List<Recipe> mRecipesList;

    public RecipeWidgetAdapter(WidgetRecipeClickListener listener) {
        mOnWidgetRecipeClickListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.widget_recipe_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mCardViewItemRecipeCard
                .setOnClickListener(v -> mOnWidgetRecipeClickListener.onWidgetRecipeClicked(recipe));
    }
    ...
    public interface WidgetRecipeClickListener {
        void onWidgetRecipeClicked(Recipe recipe);
    }
}